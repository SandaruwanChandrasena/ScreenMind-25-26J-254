...
/**
 * Get app usage statistics from Android for the last 24 hours.
 *
...
export async function getUsageStats() {
  try {
    ...
    // ✅ FIX: pass start/end time range (last 24 hours) — required by native module
    const end   = Date.now();
    ...
    // ✅ FIX: normalize field names — native may return totalTimeMs OR totalTimeInForeground
